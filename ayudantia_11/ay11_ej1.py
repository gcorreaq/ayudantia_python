...
def main():
	...
	print 'Bloque valido [Esperado: True]:', bloque_valido(array([0, 1, 0, 1, 0, 1, 1, 1, 0, 0, 1, 0]))
	print 'Bloque valido [Esperado: False]:', bloque_valido(array([0, 1, 0, 1, 0, 1, 1, 1, 0, 0, 1, 0, 1]))
